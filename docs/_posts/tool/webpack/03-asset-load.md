...
[示例代码仓库](https://github.com/jwchan1996/webpack-play/blob/main/03-asset-load)

## 模块处理

`webpack` 默认会把遇到的所有文件都当成是 `js` 文件去进行模块解析，其他类型的文件则需要配置对应的 `loader` 进行解析处理。

![01](~public/webpack/03/01.png)
...
![03](~public/webpack/03/03.png)
![04](~public/webpack/03/04.png)
![05](~public/webpack/03/05.png)
