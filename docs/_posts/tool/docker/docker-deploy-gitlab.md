...
![设置语言](~public/docker/docker_deploy_gitlab/01.png)
...
![runner列表](~public/docker/docker_deploy_gitlab/02.png)
...
![激活的runner](~public/docker/docker_deploy_gitlab/03.png)
...
![配置runner共享](~public/docker/docker_deploy_gitlab/04.png)
...
![关闭默认](~public/docker/docker_deploy_gitlab/05.png)
...
![提交代码](~public/docker/docker_deploy_gitlab/06.png)

![运行通过](~public/docker/docker_deploy_gitlab/07.png)
...
![身份认证](~public/docker/docker_deploy_gitlab/08.png)
